...
public class runnerrun extends AbstractSoapUITestRunner
{
	...
	{
		System.exit( new runnerrun().runFromCommandLine( args ) );
	}
	...
	public runnerrun()
	{
		super( runnerrun.TITLE );
	}

	public runnerrun( String title )
	{
		super( title );
	}
